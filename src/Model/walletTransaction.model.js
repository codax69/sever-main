...
walletTransactionSchema.methods.reverse = async function(session) {
  ...
  const reversalTxn = await this.constructor.create([{
    ...
    amount: this.amount,
    openingBalance: this.closingBalance,
    closingBalance: this.closingBalance + this.amount,
...
// Static Methods
walletTransactionSchema.statics.getCurrentBalance = async function(walletId, session = null) {
